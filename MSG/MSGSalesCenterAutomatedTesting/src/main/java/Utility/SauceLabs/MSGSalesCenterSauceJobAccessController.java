...
/**
 * Utility class for SAUCE REST API Access Controller
 *
 * @author MSG QA Automation Team
 * @version 1.0
 * @category MSG Sales Center Saucelabs Access Controller
 * @since 05/10/2017, 6:30PM EST
 */

public class MSGSalesCenterSauceJobAccessController implements Serializable {
	/**
	 * Logger instance.
	 */
	private static final Logger logger = Logger
			.getLogger(MSGSalesCenterSauceJobAccessController.class.getName());
	/**
	 ...
	 *            Sauce REST API
	 */
	public MSGSalesCenterSauceJobAccessController(String username,
			String accessKey) {
	...
	public static void setExtraUserAgent(String extraUserAgent) {
		MSGSalesCenterSauceJobAccessController.extraUserAgent = extraUserAgent;
	}
	...
	public String doJSONPOST(URL url, JSONObject body)
			throws MSGSalesCenterSauceException {
		...
		try {
			...
			if (postBack instanceof HttpsURLConnection) {
				MSGSalesCenterSauceSSLSocketFactory factory = new MSGSalesCenterSauceSSLSocketFactory();
			...
			try {
				if (postBack.getResponseCode() == 401) {
					throw new MSGSalesCenterSauceException.NotAuthorized();
				}
...
<<<<<<< HEAD
	 * the key &lt;username&gt;:&lt;api key&gt; (see
	 * <a href="http://saucelabs.com/docs/integration#public-job-links"
	 * >http://saucelabs.com/docs/integration#public-job-links</a>).
=======
...
>>>>>>> master
	...
	public String getPublicJobLink(String jobId) {
		try {
			...
			String auth_token = MSGSalesCenterSecurityUtils
	 ...
	 * Labs. (see <a href=
<<<<<<< HEAD
	 * "https://docs.saucelabs.com/reference/rest-api/#get-supported-platforms"
	 * >https
	 * ://docs.saucelabs.com/reference/rest-api/#get-supported-platforms</a>).
=======
...
>>>>>>> master
	...
	public boolean recordCI(String platform, String platformVersion) {
		...
		} catch (MSGSalesCenterSauceException e) {
			return false;
		}
		return true;
	}
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof MSGSalesCenterSauceJobAccessController)) {
			return super.equals(obj);
		}
		MSGSalesCenterSauceJobAccessController sauceobj = (MSGSalesCenterSauceJobAccessController) obj;
