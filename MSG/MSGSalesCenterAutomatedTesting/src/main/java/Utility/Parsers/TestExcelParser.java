...
public class TestExcelParser {
	...
	public static void main(String[] args) throws IllegalAccessException,
		...
		// Execute the verification in list of valid/invalid URLs
		// test.getAllValidURLsWithNav("http://softlaunch.msg.com");
	}
	...
	public List<String> getAllValidURLs(String testEnvrionment) {
		...
		for (currentSuiteID = 2; currentSuiteID <= suiteXLS.getRowCount(
			...
			if (currentTestCaseDescription != null) {
				...
				try {
					if (MSGOnlineDigitalReusableFunctionalities
							.verifyIfLinkIsWorking(testEnvrionment
