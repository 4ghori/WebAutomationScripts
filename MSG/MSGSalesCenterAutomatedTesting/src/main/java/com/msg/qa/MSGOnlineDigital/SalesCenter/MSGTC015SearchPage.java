...
/**
 * Page Class for MSG.com Search Page
 *
 * @author Carlos Campino
 * @category MSG.com Search Page
 */

public class MSGTC015SearchPage {
	private static final Logger LOGGER = Logger
			.getLogger(MSGTC015SearchPage.class);
	 ...
	 * @param selectors
	 */
	public MSGTC015SearchPage(WebDriver driver, String URL,
...
LOGGER.info(" >>>> CAPABILITIES::"+capabilities.getPlatform().toString());
	...
	public boolean MSGTC015SearchPageTS001() {
		...
		LOGGER.info(this.myDriverParameters+
				" - MSG.com Search Page: Test Step-1: Verify Page Opens.");
		try {
			...
			if (isIOSPlatform(((RemoteWebDriver) driver).getCapabilities()
				 ...
				 * selectors, "MSGTC015SearchPageLocationAlert");
				 * locationAlertElement.click();
				 */

				LOGGER.info(this.myDriverParameters+
						" - MSG.com Search Page:  Test Step-1: We are auto accepting the Location Alert.");
			}
			isMyTestPassed = true;
			LOGGER.info(this.myDriverParameters+
					" - MSG.com Search Page:  Test Step-1: We are on MSG.com Search Page.");
		} catch (WebDriverException e) {
			LOGGER.error(this.myDriverParameters+
					" - MSG.com Search Page:  Test Step-1: We are not on MSG.com Search Page!!");
	...
	public boolean MSGTC015SearchPageTS002() {
		...
		String pageName = "MSG.com - Search Page";
		String testNumber = "2";
	 ...
	 */
	@Test(description = "MSG.com - Search Page. Mega Nav Tests", groups = {
			"MSGLandingPage", "fullintegration"})
	public boolean MSGTC015SearchPageTS003() 
	{
		String pageName = "MSG.com - Search Page";
		String testNumber = "3";
		...
		try {
			...
			WebElement msgLogo = getWebElement(driver,
					selectors, "MSGTC015SearchPageLogo");
			List<WebElement> graphicTickets = getWebElements(driver,
					selectors, "MSGTC015SearchPageMegaNavEventsTicketsFindTicketsGraphicOnes");
			List<WebElement> exploreTickets = getWebElements(driver,
					selectors, "MSGTC015SearchPageMegaNavEventsTicketsFindTicketsExplore");
			WebElement msgEventTickets = getWebElement(driver,
					selectors, "MSGTC015SearchPageMegaNavEventsTickets");
...
*/			
			...
			WebElement msgSearch = getWebElement(driver,
					selectors, "MSGTC015SearchPageMegaNavSearch");
			WebElement msgSearchInput = getWebElement(driver,
					selectors, "MSGTC015SearchPageMegaNavSearchInput");
			WebElement msgSearchClose = getWebElement(driver,
					selectors, "MSGTC015SearchPageMegaNavSearchClose");
			WebElement msgSearchClick = getWebElement(driver,
					selectors, "MSGTC015SearchPageMegaNavSearchClick");
			...
			if(msgSearch.isDisplayed())
			{
				...
				if(msgSearchInput.isDisplayed() && msgSearchClick.isDisplayed())
				{
					...
					LOGGER.info(this.myDriverParameters+" - MSG.com Search Page:  Test Step-3: Madison is entered in search.");
					msgSearchClick.click();
					Thread.sleep(2000);
					
					WebElement msgSearchTotalEventCount = getWebElement(driver,
							selectors, "MSGTC015SearchPageMegaNavSearchAfterClickTotalEventCount");
					List<WebElement> msgSearchIndivEventCount = getWebElements(driver,
									selectors, "MSGTC015SearchPageMegaNavSearchAfterClickIndivEventCount");
					
					LOGGER.info(this.myDriverParameters+" - MSG.com Search Page:  Test Step-3: Total "+msgSearchTotalEventCount.getText()+" search string.");
					...
					for(WebElement myEle: msgSearchIndivEventCount)
					{
						if (count > 0)
						{
							LOGGER.info(this.myDriverParameters+" - MSG.com Search Page:  Test Step-3: "+myEle.getText()+" are present in search results.");
						}
					count++;
					}
					
					WebElement msgSearchAfterInput = getWebElement(driver,
							selectors, "MSGTC015SearchPageMegaNavSearchAfterInput");
					WebElement msgSearchAfterClick = getWebElement(driver,
							selectors, "MSGTC015SearchPageMegaNavSearchAfterClick");
					...
					LOGGER.info(this.myDriverParameters+" - MSG.com Search Page:  Test Step-3: Madison Square is entered in search.");
					...
					LOGGER.info(this.myDriverParameters+" - MSG.com Search Page:  Test Step-3: Madison Square Garden is entered in search.");
					Thread.sleep(3000);
					msgSearchAfterClick.click();
					Thread.sleep(2000);		
					...
					LOGGER.info(this.myDriverParameters+" - MSG.com Search Page:  Test Step-3: Not_a_Valid_String is entered in search.");
					msgSearchAfterClick.click();
					Thread.sleep(2000);
					
					WebElement msgSearchNoEventMessage = getWebElement(driver,
							selectors, "MSGTC015SearchPageMegaNavSearchAfterClickNoEventMessage");
					LOGGER.info(this.myDriverParameters+" - MSG.com Search Page:  Test Step-3: Message - "+msgSearchNoEventMessage.getText()+" for Not_a_Valid_String search string.");					
					...
					LOGGER.info(this.myDriverParameters+" - MSG.com Search Page:  Test Step-3: BLANK is entered in search.");
					msgSearchAfterClick.click();
					Thread.sleep(2000);
					
					WebElement msgSearchBlankMessage = getWebElement(driver,
							selectors, "MSGTC015SearchPageMegaNavSearchAfterClickNoEventMessage");
					LOGGER.info(this.myDriverParameters+" - MSG.com Search Page:  Test Step-3: Message - "+msgSearchBlankMessage.getText()+" for BLANK search string.");					
					...
					LOGGER.info(this.myDriverParameters+" - MSG.com Search Page:  Test Step-3: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. is entered in search.");
					msgSearchAfterClick.click();
					Thread.sleep(2000);
					msgSearchTotalEventCount = getWebElement(driver,
							selectors, "MSGTC015SearchPageMegaNavSearchAfterClickTotalEventCount");
	 ...
	 */
	@Test(description = "MSG.com - Search Page. Hero Slider Tests", groups = {
			"MSGLandingPage", "fullintegration"})
	public boolean MSGTC015SearchPageTS004() {
		...
		try {
			...
			List<WebElement> heroSliderSlides = getWebElements(driver,
					selectors, "MSGTC015SearchPageHeroSliderSlides");
			isMyTestPassed = true;
	 ...
	 */
	@Test(description = "MSG.com - Search Page. Hero Filters Tests", groups = {
			"MSGLandingPage", "fullintegration"})
	public boolean MSGTC015SearchPageTS005() {

		LOGGER.info(this.myDriverParameters+
				" - MSG.com - Search Page: Test Step-5: Verify Hero Section.");
		...
		try {
			...
			List<WebElement> heroFiltersTypeList = getWebElements(driver, selectors,
					"MSGTC015SearchPageHeroFiltersType");
			...
			for(WebElement myEle: heroFiltersTypeList)
			{
				if (count == 0)
				{
					...
					if (heroFiltersType.isDisplayed()
						...
						LOGGER.info(this.myDriverParameters+
								" - MSG.com - Search Page: Test Step-5: Second Line for Hero Filter Type is present");
					} else {
						isMyTestPassed = false;
					}
				}
				...
				if (count == 1)
				{
					...
					if (heroFiltersHappening.isDisplayed()
						...
						LOGGER.info(this.myDriverParameters+
								" -  MSG.com - Search Page: Test Step-5: Hero Filter Happening is present");
					} else {
						isMyTestPassed = false;
					}
				}
				...
				if (count == 2)
				{
					...
					if (heroFiltersLocation.isDisplayed()
						...
						LOGGER.info(this.myDriverParameters+
								" - MSG.com - Search Page: Test Step-5: Hero Filter Location is present");
					} else {
						isMyTestPassed = false;
					}
				}
...
/*			WebElement heroFiltersHappening = getWebElement(driver, selectors,
			...
			if (heroFiltersButton.isDisplayed()
				...
				LOGGER.info(this.myDriverParameters+
						" - MSG.com - Search Page: Test Step-5: Hero Filter BUtton is present");
			} else {
				isMyTestPassed = false;
			}
			...
			LOGGER.info(this.myDriverParameters+
					" - MSG.com - Search Page: Test Step-5: MSG Hero Filter Elements are missing!!");
			LOGGER.error(this.myDriverParameters+" - "+e);
			return false;
		}
	 ...
	 */
	@Test(description = "MSG.com - Search Page. Featured Events Tests", groups = {
			"MSGLandingPage", "fullintegration"})
	public boolean MSGTC015SearchPageTS006() {
	 ...
	 */
	@Test(description = "MSG.com - Search Page. Feature Event Advertisement", groups = {
			"MSGLandingPage", "fullintegration"})
	public boolean MSGTC015SearchPageTS007() {
	 ...
	 */
	@Test(description = "MSG.com - Search Page. Slick Slider", groups = {
			"MSGLandingPage", "fullintegration"})
	public boolean MSGTC015SearchPageTS008() {
	 ...
	 */
	@Test(description = "MSG.com - Search Page. Venues List", groups = {
			"MSGLandingPage", "fullintegration"})
	public boolean MSGTC015SearchPageTS009() {
	 ...
	 */
	@Test(description = "MSG.com - Search Page. Footer", groups = {
			"MSGLandingPage", "fullintegration"})
	public boolean MSGTC015SearchPageTS010() {
