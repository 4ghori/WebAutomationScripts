...
public class MSGSalesCenterTC008VenueRentalsMSGRadioCityPage {
	private static final Logger LOGGER = Logger
			.getLogger(MSGSalesCenterTC008VenueRentalsMSGRadioCityPage.class);
	 ...
	 * Default Constructor
	 */
	public MSGSalesCenterTC008VenueRentalsMSGRadioCityPage() {
	 ...
	 * @param selectors
	 */
	public MSGSalesCenterTC008VenueRentalsMSGRadioCityPage(WebDriver driver,
	...
	/**
	 * Step-1. We are navigable to MSG Sales Center Venue rentals Radio City
	 * Page.
	 */
	@Test(description = "Sales Center - Venue rentals - Radio City Tests", groups = {
			"MSGSalesCenterRadioCityPage", "smoke", "fullintegration"})
	public boolean MSGSalesCenterTC008VenueRentalsMSGRadioCityPageTS001() {
		try {
			// Verify the Title of the page.
			LOGGER.info(this.myDriverParameters+
					" - ******************* MSG Sales Center - Venue Rentals - Radio City Page URL to be tested is: "
							+ this.URL + " ******************* ");
			driver.navigate().to(this.URL);
			isMyTestPassed = true;
			LOGGER.info(this.myDriverParameters+
					" - MSG Sales Center Venue Rentals Radio City: Test Step-1: We are on MSG Sales Center Venue Rentals Radio City Page.");
		} catch (WebDriverException e) {
			isMyTestPassed = false;
			LOGGER.error(this.myDriverParameters+
					" - MSG Sales Center Venue Rentals Radio City: Test Step-1: We are not on MSG Sales Center Venue Rentals Radio City Page!!");
		}
	...
	{
		String pageName = "MSG.com - Venue Rentals - Radio City Page";
		String testNumber = "5";
