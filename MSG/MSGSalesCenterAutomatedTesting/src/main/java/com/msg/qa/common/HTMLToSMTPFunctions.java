...
public class HTMLToSMTPFunctions {
	private static final Logger logger = Logger
			.getLogger(HTMLToSMTPFunctions.class);
	...
	public String urlToHTML(String htmlURL) throws IOException {
		...
		String htmlWithoutAppleWebData = buffer.toString().replace("href=\"//",
				"href=\"http://");
		System.out.println(htmlWithoutAppleWebData.contains("href=\"//"));
		return htmlWithoutAppleWebData;
	}

	public void htmlToSMTP(String emailBody, String reportRecipientEmailList,
			String reportRecipientSubject) {
		String to = reportRecipientEmailList;
		String from = "msgtesting@msg.com";
		Properties properties = System.getProperties();

		properties.setProperty("mail.smtp.host", "localhost");// change
																// accordingly
		...
		Session session = Session.getInstance(properties,
				new javax.mail.Authenticator() {
					protected PasswordAuthentication getPasswordAuthentication() {
						return new PasswordAuthentication("msgtesting@msg.com",
								"NULL");
					}
				});
	...
	public String reportRowBuilder(String ROWNUMBER, String IDURL,
			String IDNAME, String STATUSBACKGROUNDCOLOR, String EXECUTIONSTATUS,
			String SUMMARYPREFIX, String SUMMARYDESCRIPTION, String EXECUTEDBY,
			String EXECUTEDON) throws IOException {

		String reportRow;

		reportRow = fileToString(
				"ReportTemplate/HTMLEmailReportTemplateRow.html");
		...
		reportRow = reportRow.replace("STATUSBACKGROUNDCOLOR",
	...
	public String completeHTMLReport(String reportTitle, String reportRowSet)
			throws IOException {
		String reportPrefix = fileToString(
				"ReportTemplate/HTMLEmailReportTemplatePrefix.html")
						.replace("HTMLREPORTTITLE", reportTitle);
		String reportSuffix = fileToString(
				"ReportTemplate/HTMLEmailReportTemplateSuffix.html");
