...
public class MSGOnlineDigitalSauceJobUpdateStatus {
	private static Map<String, Object> myUpdates;

	public static void main(String args[]) throws IOException {
		MSGOnlineDigitalSauceJobAccessController mySauce = new MSGOnlineDigitalSauceJobAccessController(
				"rachit", "05d919ba-84e4-49fb-b84c-69f8af1918bf");
