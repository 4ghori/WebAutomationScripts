...
public class MSGTC013RangersTicketsPage {
	private static final Logger LOGGER = Logger
			.getLogger(MSGTC013RangersTicketsPage.class);
	 ...
	 * Default Constructor
	 */
	public MSGTC013RangersTicketsPage() {
	 ...
	 * @param selectors
	 */
	public MSGTC013RangersTicketsPage(WebDriver driver, String URL,
	...
	/**
	 * Step-1. We are navigable to MSG Rangers Tickets Page.
	 */
	@Test(description = "MSG.com Rangers Tickets Tests", groups = {
			"MSGRangersTicketsPage", "smoke", "fullintegration"})
	public boolean MSGTC013RangersTicketsPageTS001() {
		try {
			// Verify the Title of the page.
			LOGGER.info(this.myDriverParameters+
					" - ******************* MSG Rangers Tickets Page URL to be tested is: "
							+ this.URL + " ******************* ");
			driver.navigate().to(this.URL);
			isMyTestPassed = true;
			LOGGER.info(this.myDriverParameters+
					" - MSG Rangers Tickets: Test Step-1: We are on MSG Rangers Tickets Page.");
		} catch (WebDriverException e) {
			isMyTestPassed = false;
			LOGGER.error(this.myDriverParameters+
					" - MSG Rangers Tickets: Test Step-1: We are not on MSG Rangers Tickets Page!!");
		}
	...
	/**
	 * Visual Test Enablement for Rangers Tickets Page.
	 * @author Rachit Kumar Rastogi
	 * @return
	 */
	public boolean executeVisualTest()
	{
		String pageName = "MSG.com - Rangers Tickets Page";
