...
public class SauceJobAccessController implements Serializable {
	/**
	 * Logger instance.
	 */
	private static final Logger logger = Logger
			.getLogger(SauceJobAccessController.class.getName());
	/**
	 ...
	 *            Sauce REST API
	 */
	public SauceJobAccessController(String username,
			String accessKey) {
	...
	public static void setExtraUserAgent(String extraUserAgent) {
		SauceJobAccessController.extraUserAgent = extraUserAgent;
	}
...
>>>>>>> master
	...
	public String getPublicJobLink(String jobId) {
		try {
			...
			String auth_token = SauceSecurityUtils
...
>>>>>>> master
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof SauceJobAccessController)) {
			return super.equals(obj);
		}
		SauceJobAccessController sauceobj = (SauceJobAccessController) obj;
