 ...
 * @throws IOException
 */
public static void main(String args[]) throws UniformInterfaceException, URISyntaxException, ParseException, java.text.ParseException, IOException
	{
		/**
		...
		// Test Cycle
		cycleId = myMSGJiraUpdater.createTestCycleInJira("My Test Cycle");
		 ...
		 */
		//myMSGJiraUpdater.createAnAttachmentInJira();
...
public String createTestCycleInJira(String testCycleName) throws ParseException, URISyntaxException, java.text.ParseException, IOException
{
	String cycleId = null;
 ...
 * @throws IOException
 */
public String createTestCycleInJira(String testCycleName, String startDate, String endDate) throws ParseException, URISyntaxException, java.text.ParseException, IOException
{
	String cycleId = null;
	boolean isCycleExistingAlready = false;
 ...
 * @throws IOException
 */
public String createTestCaseInJira(String testCase) throws ParseException, URISyntaxException, java.text.ParseException, IOException
{
 ...
 * @throws IOException
 */
public void createTestStepInJira(String testCaseIssueId, String testCase, String testStepName, String testStepData, String testStepResult) throws ParseException, URISyntaxException, java.text.ParseException, IOException
{
...
public void createAutomaticTestCasesUsingSprintDataInAProject(String BoardName) throws URISyntaxException, ParseException, java.text.ParseException, IOException
{
...
public void createAnAttachmentInJira(String Issue, String FileName) throws JSONException, URISyntaxException, java.text.ParseException, IOException
{
	zephyrUtilities myzephyr = new zephyrUtilities();
	
	//myzephyr.addAttachment(projectId, versionId, cycleId, issueId, entityId, resource);

	myzephyr.addAttachment(projectId, versionId, cycleId, Issue, FileName);
}
