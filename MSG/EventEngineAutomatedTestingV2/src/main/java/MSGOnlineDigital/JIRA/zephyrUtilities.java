...
{
    ZFJCloudRestClient client = ZFJCloudRestClient.restBuilder(zephyrBaseUrl, this.apiKey, this.secretKey, this.userName).build();
 ...
 * @throws IOException
 */
public String createTestCycle(String resource, StringEntity executeTestsJSON) throws URISyntaxException, ParseException, org.apache.http.ParseException, IOException
{
	String cycleId = null;
	String createCycleUri = zephyrBaseUrl + resource;
	URI uri = new URI(createCycleUri);
 ...
 * @throws IOException
 */
public void assignTestCaseToACycle(String testCase, String resource, StringEntity executeTestsJSON) throws URISyntaxException, ParseException, org.apache.http.ParseException, IOException
{
	String createCycleUri = zephyrBaseUrl + resource;
	URI uri = new URI(createCycleUri);
 ...
 * @throws IOException
 */
public void assignTestStepToTestCase(String resource, StringEntity executeTestsJSON) throws URISyntaxException, ParseException, org.apache.http.ParseException, IOException
{
	String createCycleUri = zephyrBaseUrl + resource;
	URI uri = new URI(createCycleUri);
...
public void addAttachment(int projectId, int versionId, String cycleId, String issueId,String entityId) throws URISyntaxException, ParseException, IOException, JSONException {
	...
	// File Path needs to be replaced with the test results as per the project.
	//final String fileWithAbsolutePath = "/Users/rastogir/git/RockettesAutomatedTesting/Rockettes/test-output/emailable-report.html";   
	final String fileWithAbsolutePath = entityId;   
