 ...
 */
public String getUserAssignedToStoryInJira(String IssueKey) throws URISyntaxException, JSONException
{
	String getIssueURL = jiraBaseUrl + "/rest/api/latest/issue/" + IssueKey;
	URI uri = new URI(getIssueURL);
 ...
 * @throws JSONException 
 */
public String createIssueInJira(int projectId, String componentId, String bugToBeAssignedToUser, String bugDescription) throws URISyntaxException, ParseException, org.apache.http.ParseException, IOException, JSONException
{
 ...
 * @throws JSONException 
 */
public void linkIssueWithUserStoryInJira(String inwardIssue, String outwardIssue) throws org.apache.http.ParseException, IOException, URISyntaxException, JSONException
{
 ...
 * @throws JSONException 
 */
public void createBugWithUserAssignmentInJira(String TestCaseKey, String ConsolidatedTestResults, boolean isAllTestResulInOneBugCard, String bugDescription) throws URISyntaxException, org.apache.http.ParseException, ParseException, IOException, JSONException
{
 ...
 * @throws JSONException 
 */
public String createTestInJira(int projectId, String componentId, String bugToBeAssignedToUser, String bugDescription) throws URISyntaxException, ParseException, org.apache.http.ParseException, IOException, JSONException
{
	String getIssueURL = jiraBaseUrl + "/rest/api/2/issue";
	URI uri = new URI(getIssueURL);
 ...
 * @throws JSONException 
 */
public HashMap<String, String> getAllBoardNameAndIdsForAProject() throws URISyntaxException, JSONException
{
 ...
 * @throws JSONException 
 */
public HashMap<String, String[]> getActiveSprintNameAndIdsForABoard(String boardId) throws URISyntaxException, JSONException
{
 ...
 * @throws JSONException 
 */
public HashMap<String, String[]> getAllIssuesInActiveSprintOfABoard(String boardId, String sprintId, boolean skipCompletedUserStories) throws URISyntaxException, JSONException
{
