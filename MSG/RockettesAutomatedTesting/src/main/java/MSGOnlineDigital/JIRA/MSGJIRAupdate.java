 ...
 */
public	MSGJIRAupdate(String projectId, int versionId, String cycleId) throws JSONException
	{	
 ...
 * @throws JSONException 
 */
public	MSGJIRAupdate(String projectId, int versionId, String cycleId, JIRAUtilities jiraUtilities) throws JSONException
	{	
		this.projectId = JIRAMetaData.getProjectId(projectId);
		this.versionId = versionId;
		MSGJIRAupdate.cycleId = getcycleId(cycleId, this.projectId, this.versionId);
 ...
 * @throws JSONException 
 */
public static void main(String args[]) throws UniformInterfaceException, URISyntaxException, ParseException, java.text.ParseException, IOException, InterruptedException, JSONException
	{
		/**
 ...
 * @throws JSONException 
 */
public static String getcycleId(String Cycle, int projectId, int versionId) throws JSONException 
{
	ZephyrUtilities myzephyr = new ZephyrUtilities();		
 ...
 * @throws JSONException 
 */
public List<String> getAllTestCaseNamesForATestCycle() throws JSONException 
{
 ...
 * @throws JSONException 
 */
public Map<String, String> getAllIssueSummaryAndKeysAssignedToACycle() throws JSONException 
{
	ZephyrUtilities myzephyr = new ZephyrUtilities();	
	Map<String, String> myIssuesWithId = new HashMap<String, String>();
	try {
 ...
 * @throws JSONException 
 */
public Map<String, String> getAllIssueKeysAndSummaryAssignedToACycle() throws JSONException 
{
	ZephyrUtilities myzephyr = new ZephyrUtilities();	
	Map<String, String> myIssuesWithId = new HashMap<String, String>();
	try {
 ...
 * @throws JSONException 
 */
public Map<String, String> getAllTestCaseNamesWithTestCaseIdForATestCycle() throws JSONException 
{
	ZephyrUtilities myzephyr = new ZephyrUtilities();	
	Map<String, String> myIssuesWithId = new HashMap<String, String>();
	try {
 ...
 * @throws JSONException 
 */
public List<String> getAllTestStepNamesForATestCase(String cycleId, String testCase) throws JSONException 
{
 ...
 * @throws JSONException 
 */
public List<String> getAllCycleNamesForAProject() throws JSONException 
{
 ...
 * @throws JSONException 
 */
public Map<String, String> getAllCycleNamesAndCycleIdForAProject() throws JSONException 
{
	ZephyrUtilities myzephyr = new ZephyrUtilities();		
	Map<String, String> myMappingList = new HashMap<String, String>();	
	try {
...
public List<List<String>> getJiraReportingData() throws URISyntaxException, JSONException 
{
 ...
 * @throws JSONException 
 */
public void generateHTMLJIRAReport() throws URISyntaxException, JSONException
{
...
public String createTestCycleInJira(String testCycleName) throws ParseException, URISyntaxException, java.text.ParseException, IOException, InterruptedException, JSONException
{
	String cycleId = null;
 ...
 * @throws JSONException 
 */
public String createTestCycleInJira(String testCycleName, String startDate, String endDate) throws ParseException, URISyntaxException, java.text.ParseException, IOException, InterruptedException, JSONException
{
	String cycleId = null;
	boolean isCycleExistingAlready = false;
 ...
 * @throws JSONException 
 */
public String createTestCaseInJira(String testCase) throws ParseException, URISyntaxException, java.text.ParseException, IOException, InterruptedException, JSONException
{
 ...
 * @throws JSONException 
 */
public void createTestStepInJira(String testCaseIssueId, String testCase, String testStepName, String testStepData, String testStepResult) throws ParseException, URISyntaxException, java.text.ParseException, IOException, InterruptedException, JSONException
{
...
public void createAutomaticTestCasesUsingSprintDataInAProject(String BoardName) throws URISyntaxException, ParseException, java.text.ParseException, IOException, InterruptedException, JSONException
{
